...
#
# The optional second parameter, debug, is used to set debugging behavior
# for Parallel::ForkManager.  Default value for debug is 0 (off).
#
# The optional third parameter, params, is only used if you want to customize
...
# - params['serialize_as'] represents how the data will be serialized (NOTE: currently unimplemented in Parallel::ForkManager 1.5.0).
#
...
# was adapted to Parallel::ForkManager 1.5.0 from Perl Parallel::ForkManager.
